...
namespace NoteableApi.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "ForumQuestionComments",
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ForumQuestionId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ForumQuestionComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ForumQuestionComments_AspNetUsers_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ForumQuestionComments_ForumQuestions_ForumQuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MentorFeedback_MentorProfiles_MentorProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ForumQuestionComments_AuthorId",
                table: "ForumQuestionComments",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_ForumQuestionComments_CreatedAt",
                table: "ForumQuestionComments",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_ForumQuestionComments_ForumQuestionId",
                table: "ForumQuestionComments",
                column: "ForumQuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_MentorFeedback_CreatedAt",
                table: "MentorFeedback",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_MentorFeedback_MentorProfileId",
                table: "MentorFeedback",
